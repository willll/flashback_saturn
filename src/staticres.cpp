...
const uint8_t Cutscene::_musicTableDOS[] = {
	0x10, 0x15, 0x15, 0xFF, 0x15, 0x19, 0x0F, 0xFF, 0x15, 0x04, 0x15, 0xFF, 0xFF, 0x16, 0x19, 0x15,
	0x15, 0x0D, 0x15, 0x0D, 0x18, 0x13, 0xFF, 0xFF, 0xFF, 0x14, 0x14, 0x14, 0x14, 0x14, 0xFF, 0xFF,
	0x13, 0x13, 0x13, 0x13, 0x15, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x13, 0x13, 0x11, 0xFF, 0x20,
	0x0E, 0x13, 0x12, 0xFF, 0x21, 0x23, 0x0A, 0x0A, 0x15, 0x22, 0x13, 0x25, 0x15, 0x09, 0x17, 0x08,
	0x0B, 0x0C, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x24, 0xFF, 0xFF
};
/*
#ifdef LANGFR
...
const char *ModPlayer::_modulesFiles[][2] = {
	...
	{ "options",     "opt2.mod"  }, // option3
	{ "journal",     "opt1.mod"  }, // journal3
	{ "ceinture",    "ceint.mod" }, // chute3
	{ "desinteg",    "desig.mod" }, // desinte3
	{ "reunion",     "reunion.mod"   }, // capture3
	{ "voyage",      "voyage.mod"    }, // voyage3
	{ "level4",      "telea.mod" }, // telepor3
	{ "planetexplo", "tele2.mod" }, // planexp3
	{ "fin",         "fin.mod"       }, // end31
	{ "ascenseur",   "ascens.mod" }, // lift3
	{ "logo",        "logo.mod"      }, // present3
	{ "game_over",   "gameo.mod" }, // gameove3
	{ "holocube",    "holoc.mod"  }, // holo3
	{ "memoire",     "memoire.mod"   }, // memory3
	{ "chute",       "chute.mod"     }, // chutevi3
	{ "debut",       "jungle.mod"    }, // reveil3
	{ "missions",    "missi.mod" }, // misvali3
	{ "taxi",        "taxi.mod"      }, // taxi3
	{ "donneobj",    "donne.mod" }, // donner3
